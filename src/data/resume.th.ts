...
export const resumeTh: ResumeData = {
  ...
  contact: {
    id: 'contact',
    label: 'ติดต่อ',
    summary: 'พร้อมพูดคุยว่าฉันจะช่วยประสานงานหรือวิเคราะห์โครงการของคุณได้อย่างไร',
    message: 'ติดต่อได้ทุกเมื่อสำหรับงาน Project Coordination, System/Business Analysis หรือการพัฒนา',
    actions: [
      {
        label: 'อีเมลถึงธนาวุฒิ',
        action: 'mailto',
        value: 'tanawut.pongkan@gmail.com',
        successMessage: 'กำลังเปิดโปรแกรมอีเมล…',
      },
      {
        label: 'คัดลอกเบอร์โทร',
        action: 'copy',
        value: '+66954749426',
        successMessage: 'คัดลอกเบอร์แล้ว',
      },
    ],
  },
  footer: {
